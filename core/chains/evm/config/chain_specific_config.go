...
func setChainSpecificConfigDefaultSets() {
	...
	apothem := fallbackDefaultSet
	apothem.blockHistoryEstimatorBlockHistorySize = 4 // EIP-1559 does well on a smaller block history size
	apothem.blockHistoryEstimatorTransactionPercentile = 50
	apothem.eip1559DynamicFees = true // enable EIP-1559 on Eth Mainnet and all testnets
	apothem.linkContractAddress = "0x514910771AF9Ca656af840dff83E8264EcF986CA"
	apothem.minimumContractPayment = assets.NewLinkFromJuels(100000000000000000) // 0.1 LINK
	apothem.operatorFactoryAddress = "0x3e64cd889482443324f91bfa9c84fe72a511f48a"
	...
	XdcMainnet.eip1559DynamicFees = false
	XdcApothem :=apothem
	XdcApothem.linkContractAddress ="0x33f4212b027e22af7e6ba21fc572843c0d701cd1" 
	XdcApothem.eip1559DynamicFees = false
	...
	chainSpecificConfigDefaultSets[50] = XdcMainnet
	chainSpecificConfigDefaultSets[51] = XdcApothem
