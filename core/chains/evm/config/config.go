...
func (c *chainScopedConfig) EvmGasFeeCapDefault() *assets.Wei {
...
func (c *chainScopedConfig) EvmGasTipCapDefault() *assets.Wei {
...
func (c *chainScopedConfig) EvmGasTipCapMinimum() *assets.Wei {
