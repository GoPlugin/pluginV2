  ...
  AuthorizedReceiver
{
  ...
  AggregatorV3Interface private PLI_ETH_FEED;
   ...
   * @return pliAddress address of contract for the PLI token
   * @return pliPriceFeed address of contract for a conversion price between PLI token and native token
   */
  function getConfig()
    external
    view
